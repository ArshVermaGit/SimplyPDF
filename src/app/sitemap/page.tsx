...
export const metadata: Metadata = {
  title: 'Sitemap | SimplyPDF',
  description: 'A complete list of all the tools and pages available on SimplyPDF.',
};
    ...
    return (
        <div className="min-h-screen pt-24 pb-16 bg-gray-50">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="mb-12">
                    <h1 className="text-4xl font-black mb-4 tracking-tight">Sitemap</h1>
