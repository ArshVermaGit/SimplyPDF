                ...
                <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <ToolCard className="p-8">
                                ...
                                >
                                    ...
                                    <p className="text-gray-400 text-sm font-medium">Supports .docx and .txt files</p>
                                </div>
                    ...
                    {status === "success" && (
                        ...
                        >
                            ...
                            <p className="text-gray-500 mb-10 text-lg">Your document has been converted to PDF.</p>
