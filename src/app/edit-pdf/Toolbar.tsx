import { MousePointer2, Type, Image as ImageIcon, Pencil, Square, Circle, Minus, Plus, Hand, Undo, Redo, ChevronDown, Move } from "lucide-react";
import { motion } from "framer-motion";

export type Tool = "select" | "hand" | "text" | "image" | "draw" | "shape" | "line" | "arrow";
...
export function Toolbar({ selectedTool, setSelectedTool, zoom, setZoom, activeShape, setActiveShape }: ToolbarProps) {
    const tools = [
    ...
    return (
        <div className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm relative z-30">
            ...
            {/* Center: Title / Context Info (Placeholder) */}
            <div className="hidden md:block absolute left-1/2 -translate-x-1/2 text-sm font-medium text-gray-400">
                Edit Mode
            </div>
